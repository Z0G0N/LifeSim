class Jobs {
    ...
    public static int Pizza_worker() {
        //random money system
    ...
    public static int Fast_Food_Worker() {
        //random money system
